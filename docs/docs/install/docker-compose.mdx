...
If you intend to use hardware acceleration for transcoding or machine learning (ML), you can download the config files you'll need now in the same way:
...
```bash title="Delete all stopped containers"
docker system prune
```
